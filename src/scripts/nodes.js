//general containers
const startSite = document.querySelector(".start");
...
const institutions = document.querySelector('.loc_con_1');
const faculties = document.querySelector('.loc_con_2');
...
const ucvBtn = document.querySelector('#UCV-btn');
const ciensBtn = document.querySelector('#ciens-btn');
const compSciBtn = document.querySelector('#compSci-btn');
const pregBtn = document.querySelector('#preg-btn');
const semestreI = document.querySelector('#smI');

const gradesStudent = document.querySelector('.grades');
const performanceIndStudent = document.querySelector('.performance-indicator');
